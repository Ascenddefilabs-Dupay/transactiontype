"""
Django settings for backend_transaction_type project.
...
ROOT_URLCONF = 'backend_transaction_type.urls'
...
WSGI_APPLICATION = 'backend_transaction_type.wsgi.application'
